    ...
    <script>
        document.getElementById('login-form').addEventListener('submit', async function (e) {
            ...
            try {
                ...
                const response = await fetch('http://localhost/VetConnect/Backend/server.php?endpoint=user/login', {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    ...
                    localStorage.setItem('jwtToken', data.token); // Simpan token ke localStorage
